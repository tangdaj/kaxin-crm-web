  ...
  <div>
    ...
    <el-card>
      ...
      <el-table
        ...
        <el-table-column prop="receiveNumber" label="接收号码"></el-table-column>
        <el-table-column prop="messageContent" label="短信内容"></el-table-column>
      ...
      <el-row>
        ...
        <el-col :span="20" :offset="10" style="margin-top: -48px">
          <el-pagination
...
export default {
  ...
  methods: {
    batchDelete() {
      ...
      if (tips) {
        this.$http.delete(`http://183.215.190.121:9999/smsSend/deleteSmsSend/${this.ids}`).then(res => {
          if (res.data > 0) {
    ...
    search() {
      ...
      this.$http.get("http://183.215.190.121:9999/smsSend/search?startTime=" + this.value1 + "&pageNum=" + this.queryInfo.pageNum + "&pageSize=" + this.queryInfo.pageSize + "&searchVal=" + this.searchVal).then(res => {
